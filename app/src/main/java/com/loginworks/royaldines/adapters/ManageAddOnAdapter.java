...
public class ManageAddOnAdapter extends RecyclerView.Adapter<ManageAddOnAdapter.AddOnViewHolder> {

    private ArrayList<AddOn> addOnArrayList;
    private Context context;
    private MyPreferences myPreferences;
    private String TAG = ManageAddOnAdapter.class.getSimpleName();
    private DataHandlerDB dataHandlerDB;


    public ManageAddOnAdapter(Context context, ArrayList<AddOn> addOnArrayList) {
